...
public class Credits : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        max = new Vector2(font.rect.height / 2, 0);
        ...
        min = new Vector2(-font.rect.height / 2, 0);//
    ...
    void FixedUpdate()
    {
        ...
        if (transform.position.y > max.y + rect.rect.height  || transform.position.y < min.y-rect.rect.height ) speed = -speed;     
